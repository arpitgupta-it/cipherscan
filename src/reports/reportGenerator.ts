...
export function generateReport(
    ...
    const logoPath = context.asAbsolutePath('src/assets/img/cipherscan-logo512.png');  // Retrieve absolute path for the logo image
    ...
    const htmlContent = generateHtmlReport(fileSummaries, fileDetails, logoPath, totalFilesScanned, secrets.length, context);
