...
1. 🔍 **Manual Scan Control**
   - Scan your entire workspace for sensitive information with a single click on the **Find Exposed Secrets** button in the VSCode status bar. Scans only run when triggered, giving you control over scan timing without disrupting your workflow.
...
[2024-11-24T11:35:25.772Z] [INFO] --------------------- Scan completed: Exposed secrets found ---------------------
